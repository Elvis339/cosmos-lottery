...
type LotteryTransaction struct {
	...
	LotteryId uint64     `protobuf:"varint,4,opt,name=lotteryId,proto3" json:"lotteryId,omitempty"`
}
...
func (m *LotteryTransaction) GetCreatedBy() string {
	if m != nil {
		return m.CreatedBy
	}
	return ""
...
func (m *LotteryTransaction) GetLotteryId() uint64 {
	if m != nil {
		return m.LotteryId
	}
	return 0
...
var fileDescriptor_d92ed16223294e7a = []byte{
	...
	,
}
...
func (m *LotteryTransaction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LotteryId != 0 {
		i = encodeVarintLotteryTransaction(dAtA, i, uint64(m.LotteryId))
		i--
		dAtA[i] = 0x20
	}
	if len(m.CreatedBy) > 0 {
		...
		i = encodeVarintLotteryTransaction(dAtA, i, uint64(len(m.CreatedBy)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *LotteryTransaction) Size() (n int) {
	...
	if m.LotteryId != 0 {
		n += 1 + sovLotteryTransaction(uint64(m.LotteryId))
	}
	return n
}
