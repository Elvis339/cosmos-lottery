...
type Lottery struct {
	...
	LotteryTransactions []*LotteryTransaction `protobuf:"bytes,4,rep,name=lotteryTransactions,proto3" json:"lotteryTransactions,omitempty"`
}
...
func (m *Lottery) GetLotteryTransactions() []*LotteryTransaction {
	if m != nil {
		return m.LotteryTransactions
	}
	return nil
}
...
var fileDescriptor_da23981c85921b2d = []byte{
	...
	,
}
...
func (m *Lottery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LotteryTransactions) > 0 {
		for iNdEx := len(m.LotteryTransactions) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LotteryTransactions[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Lottery) Size() (n int) {
	...
	n += 1 + l + sovLottery(uint64(l))
	if len(m.LotteryTransactions) > 0 {
		for _, e := range m.LotteryTransactions {
			l = e.Size()
			n += 1 + l + sovLottery(uint64(l))
		}
	}
...
func (m *Lottery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LotteryTransactions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LotteryTransactions = append(m.LotteryTransactions, &LotteryTransaction{})
			if err := m.LotteryTransactions[len(m.LotteryTransactions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
